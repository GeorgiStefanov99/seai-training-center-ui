...
export default function Features() {
  return (
    <section className="container max-w-screen-xl mx-auto space-y-16 py-24 md:py-32 px-4 md:px-6">
      <div className="mx-auto max-w-[58rem] text-center">
        <h2 className="font-bold text-3xl leading-[1.1] sm:text-3xl md:text-5xl">AI-Powered Solutions</h2>
        <p className="mt-4 text-muted-foreground sm:text-lg">
          Discover how SeAI can transform your business with our innovative AI technologies.
        </p>
      </div>
